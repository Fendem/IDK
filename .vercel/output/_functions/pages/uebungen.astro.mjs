/* empty css                                  */
import { c as createComponent, a as createAstro, e as renderComponent, i as renderSlot, r as renderTemplate, b as addAttribute, g as renderScript, h as renderHead, m as maybeRenderHead } from "../chunks/astro/server_BS_EwGH5.mjs";
import "kleur/colors";
...
import { c as cn, b as blue_parrot } from "../chunks/blue-parrot-logo_lrnY5FNr.mjs";
...
import "clsx";
import { $ as $$Image } from "../chunks/_astro_assets_4kGxcgds.mjs";
...
}, "/home/ferdi/vorrect/node_modules/@clerk/astro/components/interactive/UserProfile/UserProfile.astro", void 0);
...
function SubBadge() {
  return /* @__PURE__ */ jsx(Badge, { children: "Pro" });
}
...
function AppSidebar() {
  ...
  console.log(/* @__PURE__ */ jsx($$UserProfile, {}));
  return /* @__PURE__ */ jsxs(Sidebar$1, { variant: "floating", collapsible: "icon", children: [
    ...
    /* @__PURE__ */ jsx(SidebarFooter, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [
      /* @__PURE__ */ jsxs(SidebarMenuButton, { size: "lg", className: "relative flex items-center overflow-visible mx-auto", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "group-data-[collapsible=icon]:relative group-data-[collapsible=icon]:mx-auto group-data-[collapsible=icon]:block", children: /* @__PURE__ */ jsx(SubBadge, {}) })
      ] }),
      /* @__PURE__ */ jsxs(
        DropdownMenuContent,
        {
...
const $$Uebungen = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "CreateLayout", $$CreateLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Sidebar", Sidebar, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/app/layout", "client:component-export": "Sidebar" }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<header> <input id="middleNameInput" type="text" placeholder="Enter Middle Name"> <button onclick="saveMiddleName()">Save</button> <p id="middleNameDisplay">Your middle name: <span>-</span></p> <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-8 md:py-20"> <div class="grid items-center justify-items-start gap-8 sm:gap-0 md:grid-cols-2"> <div class="flex flex-col text-center"> <h1 class="mb-4 text-4xl font-bold md:text-6xl md:leading-tight">
Willkomen Zu <span class="main font-bold">SchreibRecht! ${renderComponent($$result3, "Username", Username, { "client:idle": true, "client:component-hydration": "idle", "client:component-path": "@/components/username", "client:component-export": "Username" })}</span> </h1> </div> ${renderComponent($$result3, "Image", $$Image, { "src": blue_parrot, "alt": "parrot", "class": "inline-block h-full w-full max-w-md" })} </div> </div> </header> ` })} ` })}`;
