import { N as NETLIFY_CACHE_BUST_PARAM } from "./chunks/chunk-DIHBIVJQ_2T0VBfgX.mjs";
...
import "kleur/colors";
import "./chunks/astro/server_CQ7_pCDq.mjs";
import "clsx";
import "cookie";
import { s as sequence } from "./chunks/index_DGf6uetZ.mjs";
async function createAsyncLocalStorage() {
  const { AsyncLocalStorage } = await import("node:async_hooks");
  return new AsyncLocalStorage();
}
var authAsyncStorage = await createAsyncLocalStorage();
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_Zml0LXNraW5rLTk2LmNsZXJrLmFjY291bnRzLmRldiQ", "SITE": void 0, "SSR": true };
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_JSHtGIJTZQpldRV7iDD2HpKQjCbHtO4VYVkhOpqPah", BROWSER: process.env.BROWSER, _: process.env._ })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.1.20"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.1.20",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_JSHtGIJTZQpldRV7iDD2HpKQjCbHtO4VYVkhOpqPah", BROWSER: process.env.BROWSER, _: process.env._ }).MODE
  },
  telemetry: {
...
function handleNetlifyCacheInDevInstance(locationHeader, requestState) {
  if (Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_JSHtGIJTZQpldRV7iDD2HpKQjCbHtO4VYVkhOpqPah", BROWSER: process.env.BROWSER, _: process.env._ }).NETLIFY && isDevelopmentFromPublishableKey(requestState.publishableKey)) {
